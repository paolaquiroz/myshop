...
<head>
    ...
    $this->helix3->addCSS('bootstrap.min.css, font-awesome.min.css,owl.theme.css, owl.carousel.css,bootstrap-select.min.css') // CSS Files
        ->addJS('bootstrap.min.js, jquery.sticky.js, main.js, owl.carousel.js, bootstrap-select.min.js') // JS Files

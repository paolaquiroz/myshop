...
<h1 class="category-title"><?php echo $this->category->category_name; ?></h1>
<?php
	...
	<div class="browse-view">
		...
		<div class="orderby-displaynumber">
			...
			<div class="floatright display-number">
				...
				<?php echo JText::_('VINA_SHOW'); ?> <div class="number"><?php echo $this->vmPagination->getLimitBox ($this->category->limit_list_step); ?></div>
			</div>
			<div class="clear"></div>
		...
		<div class="vm-pagination-bottom">
			<div class="page-count"><?php echo $this->vmPagination->getPagesCounter (); ?></div> <?php echo $this->vmPagination->getPagesLinks (); ?>
		</div>
		<?php

	...
	<div class = "vmshop-account account-login">		
		<div class = "row">
			<div class = "col-md-6 new-users">
				<div class="content">
					<h2><?php echo JText::_('VINA_VIRTUEMART_HAVE_NOT_ACCOUNT'); ?></h2>
					<p><?php echo JText::_('VINA_REGISTER_DES'); ?></p>
				</div>				
				<div class="buttons-set">
					<button type="button" title="Create an Account" class="vina-button" onclick="window.location='<?php echo JRoute::_('index.php?option=com_virtuemart&view=user&task=edit', FALSE); ?>'"><span><span><?php echo JText::_('VINA_VIRTUEMART_REGISTRATION'); ?></span></span></button>
				</div>				
			</div>
			<div class = "col-md-6 login-users">
				<form id="com-form-login" action="<?php echo JRoute::_('index.php', $this->useXHTML, $this->useSSL); ?>" method="post" name="com-login" >
					...
					<div class="buttons-set">
						<input type="submit" name="Submit" class="vina-button" value="<?php echo vmText::_('COM_VIRTUEMART_LOGIN'); ?>" />

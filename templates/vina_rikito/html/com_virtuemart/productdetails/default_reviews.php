...
";
			...
			<div class="review-button">
				<span class="counter"><?php echo vmText::_( 'COM_VIRTUEMART_REVIEW_COUNT' ) ?>
...
if ($this->showReview) {
	...
	?>
	<h3 class="title-list-reviews"><?php echo vmText::_ ('COM_VIRTUEMART_REVIEWS') ?></h3>
		...
		if ($this->rating_reviews) {
			foreach ($this->rating_reviews as $review) {
				...
				if (!empty($this->rating_reviews) && $review->published) {
					$reviews_published++;
					?>
					<div class="review-item <?php echo $color ?>">
						<b class="author"><?php echo $review->customer ?></b> 
						...
						<p class="info"><?php echo $review->comment; ?></p>
					</div>
					<?php
				}
				$i++;

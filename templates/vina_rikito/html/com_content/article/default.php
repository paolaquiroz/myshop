...
<article class="item-page post-<?php echo $this->item->id ?> post hentry <?php echo ($this->item->state == 0)?'status-unpublish alert':'status-publish'; echo ' category-'.$this->escape($this->item->category_alias) . ' ' . strtolower($this->pageclass_sfx) ?> vina-item-post"> 
	<div class="item">
		<?php
			...
			<?php if ($params->get('access-view')):?>
				...
				<header class="entry-header">
					...
					<?php elseif($this->params->get('show_page_heading', 0) && (!$params->get('show_title'))) : ?>
						<h1 class="vina-title"><span><?php echo $this->escape($this->params->get('page_heading')); ?></span></h1>
				...
				<div class="entry-meta muted clearfix">				
					...
					<?php if ($params->get('show_create_date')) : ?>
						<span class="create-date">
							<i class="fa fa-clock-o"></i> <?php echo JText::sprintf(JHtml::_('date',$this->item->created, JText::_('DATE_FORMAT_LC3'))); ?>
						</span>
					<?php endif; ?>
					<?php //End Create Date ?>
					...
					<?php if ($params->get('show_publish_date')) : ?>
						<span class="publish-date" >
							<i class="fa fa-clock-o"></i> <?php echo JText::sprintf(JHtml::_('date',$this->item->publish_up, JText::_('DATE_FORMAT_LC3'))); ?>
						</span>
					<?php endif; ?>	

...
<section class="blog <?php echo $this->pageclass_sfx;?>">
    ...
    */
	...
	<?php if (
		...
		($this->params->get('show_category_title', 1) OR $this->params->get('page_subheading')) and !$this->params->get('show_page_heading', 0)
	) : ?>
		<section class="category-desc media">
		<?php if ($this->params->get('show_description_image') && $this->category->getParams()->get('image')) : ?>
			<img class="pull-left" src="<?php echo $this->category->getParams()->get('image'); ?>" alt="<?php echo $this->category->title;?>" />
		<?php endif; ?>

...
$style = '#vina-camera-slider-wrapper' .$module->id . '{'
		. 'width:' .$moduleWidth . ';'
		. 'max-width:' . $maxWidth . ';'
		. 'clear: both;'
		. '}'
		. '#vina-copyright' . $module->id . '{'
		. 'font-size: 12px;';
if(!$params->get('copyRightText', 0)) {
$style .=  'height: 1px;';
...
?>
<div class="vina-camera-slider-wrapper <?php echo $moduleclass_sfx; ?>">
	...
	<div id="vina-camera-slider-wrapper<?php echo $module->id; ?>" class="vina-camera-slider">
		<div class="camera_wrap <?php echo $moduleStyle; ?>" id="vina-camera-slider<?php echo $module->id; ?>">
			...
			<?php
				...
				$bigImage = ($resizeImage) ? $timthumb . '&amp;w=' . $imageWidth . '&amp;h=' . $imageHeight . '&amp;src=' . $image : $bigImage;
